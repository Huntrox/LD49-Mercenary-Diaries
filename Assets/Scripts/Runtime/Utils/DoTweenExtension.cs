...
namespace HuntroxGames.Utils
{
    public static class DoTweenExtension
    {
        ...
        public static TweenerCore<string, string, StringOptions> DOText(this TextMeshPro textmesh, string endValue, float duration, bool richTextEnabled = true, ScrambleMode scrambleMode = ScrambleMode.None, string scrambleChars = null)
        {
            if (endValue == null)
            {
                endValue = "";
